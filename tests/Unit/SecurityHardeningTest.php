...
class SecurityHardeningTest extends TestCase
{
    ...
    public function testAuditLogDelegatesToRepository(): void
    {
        ...
        $this->assertStringContainsString('AuditEventRepository', $content,
            'audit_log() must delegate to AuditEventRepository');
        $this->assertStringNotContainsString('INSERT INTO audit_events', $content,
    ...
    public function testApiGuardsUseRepository(): void
    {
        ...
        $this->assertStringNotContainsString('SELECT validated_at FROM meetings', $content,
            'api_guard_meeting_not_validated must not contain raw SQL');
        $this->assertStringNotContainsString('SELECT * FROM meetings WHERE', $content,
    ...
    public function testParsedownSafeModeUsed(): void
    {
        ...
        $this->assertStringContainsString('setSafeMode(true)', $content,
