...
- 🚧 **M-AUDIT-CHEMIN** — Audit chemin critique fonctionnel (Stage 1)
- ⏳ **M-AUDIT-STACK** — Audit stack technique (Stage 2, démarre post-Stage 1)
- ⏳ **M-DECISION** — Décision direction Voie A/B/C (post-audit, branche le reste)
