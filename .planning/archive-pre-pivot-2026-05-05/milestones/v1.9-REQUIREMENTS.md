...
- [x] **NAV-04**: Page d'accueil = carte centree avec logo AG-VOTE + formulaire de connexion
...
- [x] **FEED-01**: Chaque liste/grille affiche un message clair quand vide ("Creez votre premiere seance") au lieu de skeletons suspendus
- [x] **FEED-02**: Apres un vote, confirmation persistante visible (pas un flash 3s) avec horodatage
- [x] **FEED-03**: Filtres et recherches affichent "Aucun resultat" avec suggestion de reinitialiser les filtres
