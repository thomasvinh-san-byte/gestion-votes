...
4. Audit page shows real events; SEED_EVENTS gone; error state on API failure
...
### Audit page behavior
- Delete `SEED_EVENTS` constant entirely from audit.js
...
- `audit.js`: Already has API call — just needs SEED_EVENTS fallback removal
...
- `audit.js` line 17-90+: SEED_EVENTS constant to delete
