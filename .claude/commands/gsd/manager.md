...
<execution_context>
@/home/user/gestion-votes/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @/home/user/gestion-votes/.claude/get-shit-done/workflows/manager.md end-to-end.
