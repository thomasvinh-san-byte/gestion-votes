...
<reference>
@/home/user/gestion-votes/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/gestion-votes/.claude/get-shit-done/references/user-profiling.md` to load:
