...
Use template from `/home/user/gestion-votes/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/user/gestion-votes/.claude/get-shit-done/templates/UI-SPEC.md`
