...
<required_reading>
@/home/user/gestion-votes/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@/home/user/gestion-votes/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/gestion-votes/.claude
                  → checks /home/user/gestion-votes/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/gestion-votes/.claude/get-shit-done
                  → writes to /home/user/gestion-votes/.claude/get-shit-done/hooks/
...
@/home/user/gestion-votes/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/user/gestion-votes/.claude/get-shit-done/references/common-bug-patterns.md
