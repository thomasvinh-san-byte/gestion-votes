...
```markdown
Read /home/user/gestion-votes/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/user/gestion-votes/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/user/gestion-votes/.claude/agents/gsd-ui-checker.md for instructions.
