...
```
Task(
  prompt="Read /home/user/gestion-votes/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/gestion-votes/.claude/get-shit-done/templates/VALIDATION.md`
