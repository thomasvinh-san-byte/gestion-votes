...
Read and follow `/home/user/gestion-votes/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @/home/user/gestion-votes/.claude/get-shit-done/workflows/diagnose-issues.md
