...
VALUES
  ('33333333-3333-3333-3333-333333333001','aaaaaaaa-1111-2222-3333-444444444444','admin@example.test','Admin','admin',NULL,true,now(),now()),
  ...
  ('33333333-3333-3333-3333-333333333003','aaaaaaaa-1111-2222-3333-444444444444','trust@example.test','Président','trust',NULL,true,now(),now())
ON CONFLICT (id) DO UPDATE
