...
-- ============================================================================
INSERT INTO ballots (id, tenant_id, meeting_id, motion_id, member_id, value, weight, cast_at, created_at)
VALUES
  (gen_random_uuid(),'aaaaaaaa-1111-2222-3333-444444444444','44444444-4444-4444-4444-444444444001','66666666-6666-6666-6666-666666666001','55555555-5555-5555-5555-555555555001','for',100.0000,now() - interval '18 minutes',now()),
  (gen_random_uuid(),'aaaaaaaa-1111-2222-3333-444444444444','44444444-4444-4444-4444-444444444001','66666666-6666-6666-6666-666666666001','55555555-5555-5555-5555-555555555002','for',80.0000,now() - interval '18 minutes',now()),
  (gen_random_uuid(),'aaaaaaaa-1111-2222-3333-444444444444','44444444-4444-4444-4444-444444444001','66666666-6666-6666-6666-666666666001','55555555-5555-5555-5555-555555555003','for',60.0000,now() - interval '17 minutes',now()),
  (gen_random_uuid(),'aaaaaaaa-1111-2222-3333-444444444444','44444444-4444-4444-4444-444444444001','66666666-6666-6666-6666-666666666001','55555555-5555-5555-5555-555555555004','against',40.0000,now() - interval '17 minutes',now()),
  (gen_random_uuid(),'aaaaaaaa-1111-2222-3333-444444444444','44444444-4444-4444-4444-444444444001','66666666-6666-6666-6666-666666666001','55555555-5555-5555-5555-555555555005','for',120.0000,now() - interval '17 minutes',now()),
  (gen_random_uuid(),'aaaaaaaa-1111-2222-3333-444444444444','44444444-4444-4444-4444-444444444001','66666666-6666-6666-6666-666666666001','55555555-5555-5555-5555-555555555006','for',90.0000,now() - interval '16 minutes',now()),
  (gen_random_uuid(),'aaaaaaaa-1111-2222-3333-444444444444','44444444-4444-4444-4444-444444444001','66666666-6666-6666-6666-666666666001','55555555-5555-5555-5555-555555555007','abstain',70.0000,now() - interval '16 minutes',now()),
  (gen_random_uuid(),'aaaaaaaa-1111-2222-3333-444444444444','44444444-4444-4444-4444-444444444001','66666666-6666-6666-6666-666666666001','55555555-5555-5555-5555-555555555008','for',55.0000,now() - interval '16 minutes',now()),
  (gen_random_uuid(),'aaaaaaaa-1111-2222-3333-444444444444','44444444-4444-4444-4444-444444444001','66666666-6666-6666-6666-666666666001','55555555-5555-5555-5555-555555555009','for',45.0000,now() - interval '15 minutes',now()),
  (gen_random_uuid(),'aaaaaaaa-1111-2222-3333-444444444444','44444444-4444-4444-4444-444444444001','66666666-6666-6666-6666-666666666001','55555555-5555-5555-5555-555555555010','against',85.0000,now() - interval '15 minutes',now())
