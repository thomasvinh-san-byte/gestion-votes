...
final class FieldBuilder
{
    ...
    public function required(): self { $this->definition['required'] = true; return $this; }
    public function optional(): self { $this->definition['required'] = false; return $this; }
    public function nullable(): self { $this->definition['nullable'] = true; return $this; }
    public function default(mixed $value): self { $this->definition['default'] = $value; return $this; }
    public function minLength(int $length): self { $this->definition['minLength'] = $length; return $this; }
    public function maxLength(int $length): self { $this->definition['maxLength'] = $length; return $this; }
    public function min(int|float $value): self { $this->definition['min'] = $value; return $this; }
    public function max(int|float $value): self { $this->definition['max'] = $value; return $this; }
    public function pattern(string $regex): self { $this->definition['pattern'] = $regex; return $this; }
...
final class ValidationResult
{
    ...
    public function firstError(): ?string { return reset($this->errors) ?: null; }
