...
<body style="margin:0; padding:0; background:#fbfbfb;">
  ...
  <div style="max-width:640px; margin:0 auto; padding:24px;">
    <div style="background:#ffffff; border:1px solid #e5e7eb; border-radius:16px; padding:22px;">
      ...
      <div style="margin-top:12px; color:#2c303a; font:14px/1.6 system-ui, -apple-system, Segoe UI, Roboto, Arial;">
        Vous pouvez consulter le PV et les résultats au lien suivant :
      </div>

      <div style="margin-top:18px;">
        <a href="<?= e($reportUrl) ?>"
           style="display:inline-block; background:#2d8866; color:#ffffff; text-decoration:none;
