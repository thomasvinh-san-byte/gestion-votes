...
<head>
  ...
  <meta name="description" content="Séance clôturée - AG-VOTE">
  <title>Séance clôturée - AG-VOTE</title>
...
<body class="login-page">
  <div class="login-card">
    ...
    <h2 style="text-align:center;margin-bottom:var(--space-4);">La séance est clôturée</h2>

    <p style="text-align:center;color:var(--color-text-muted);">
      Cette séance de vote a été clôturée et les résultats sont définitifs. Vous ne pouvez plus voter.
    </p>
  </div>
</body>
</html>
