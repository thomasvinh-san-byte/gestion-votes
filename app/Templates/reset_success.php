...
<head>
  ...
  <meta name="description" content="Mot de passe reinitialise — AG-VOTE">
  <title>AG-VOTE — Mot de passe reinitialise</title>
...
<body>
  ...
  <main class="login-page" role="main" id="main-content">
    <div class="login-card">
      ...
      <div class="login-form" style="text-align:center">
        ...
        <div class="login-success" role="status" style="margin:1.5rem 0">
          Votre mot de passe a ete mis a jour avec succes.
        </div>
        <a href="/login" class="login-btn" style="display:inline-block; text-decoration:none; margin-top:0.5rem">
