...
<head>
  ...
  <meta name="description" content="Vote clos - AG-VOTE">
  <title>Vote clos - AG-VOTE</title>
...
<body class="login-page">
  <div class="login-card">
    ...
    <h2 style="text-align:center;margin-bottom:var(--space-4);">Ce vote est maintenant clos</h2>

    <p style="text-align:center;color:var(--color-text-muted);">
      La résolution a été clôturée avant l'enregistrement de votre vote.
    </p>
  </div>
</body>
</html>
